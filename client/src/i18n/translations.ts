export const translations = {
  pt: {
    ...
    events: {
      ...
      heroP2: "Com tendas espaçosas, insufláveis divertidos e atividades personalizadas, garantimos que o seu evento seja um sucesso absoluto. Para além das nossas emblemáticas atividades de estratégia, como o LaserTag, PaintBall, GelBlaster e NERFs, temos outras atividades criadas à medida para cada tipo de grupo.",
  ...
  en: {
    ...
    events: {
      ...
      heroP2: "With spacious tents, fun inflatables and customized activities, we guarantee your event will be an absolute success. Beyond our iconic strategy activities such as LaserTag, PaintBall, GelBlaster and NERFs, we have other activities tailored to each type of group.",
