  ...
  pt: {
    ...
    accommodation: {
      ...
      aptFeatures: {
        ...
        t2Pico: ["2 quartos no 1º piso", "1 quarto no sótão, super acolhedor", "1 casa de banho", "1 sala ampla", "Máquina de lavar loiça e roupa"]
      },
      highlights: {
  ...
  en: {
    ...
    accommodation: {
      ...
      aptFeatures: {
        ...
        t2Pico: ["2 bedrooms on 1st floor", "1 bedroom in the attic, super cozy", "1 bathroom", "1 spacious living room", "Dishwasher and washing machine"]
      },
      highlights: {
