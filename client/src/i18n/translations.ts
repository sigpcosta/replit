export const translations = {
  pt: {
    ...
    cta: {
      ...
      subtitle: "Entre em contacto connosco e comece a planear a sua experiência perfeita nos Açores",
    ...
    footer: {
      ...
      legal: {
        termsSite: "Termos e Condições - Site",
        termsVending: "Termos e Condições - Vending",
    ...
    contactDialog: {
      title: "Contacte-nos",
      description: "Preencha o formulário abaixo e entraremos em contacto consigo brevemente.",
      name: "Nome",
      email: "Email",
      phone: "Telefone",
      message: "Mensagem",
      ...
      errorMessage: "Por favor, tente novamente ou contacte-nos diretamente.",
    },
    ...
    common: {
      ...
      faqNotFound: "Não encontrou a resposta que procurava?",
    ...
    accommodation: {
      ...
      bookingsAndAvailability: "Reservas e Disponibilidade",
      book: "Reservar",
      viewMorePhotos: "Ver mais fotos",
      ourApartments: "Os Nossos Apartamentos",
      capacity: "Capacidade",
      ...
      aptFeatures: {
        ...
        t2Pico: ["2 quartos no 1º piso", "1 quarto no sótão, super acolhedor", "1 casa de banho", "1 sala ampla", "Máquinas de lavar loiça e roupa"]
      },
      highlights: {
    ...
    activities: {
      ...
      bookActivity: "Reservar Atividade",
      viewPackages: "Ver Pacotes",
      ourActivities: "As Nossas Atividades",
      whyChoose: "Porque Escolher as Nossas Atividades",
    ...
    paintball: {
      ...
      heroP4: "Há vários tipos de jogos desafiadores e muito divertidos, que podem ser usados com qualquer tipo de marcador, como por exemplo o Equipa x Equipa, Jogo da Bandeira, Defesa da Torre ou Refém, por isso a única condição é trazer boa disposição e a tua equipa, porque quantos mais 'inimigos' existirem, mais espetacular será jogar!",
      heroP5: "Por último importa referir que as nossas bolas do Paintball e Gelblaster são biodegradáveis, pelo que depois de uma normal 'chuvinha' a tinta desaparece completamente, além disso estamos confinados num campo exclusivo para esta atividade, pelo que não deixaremos vestígios na paisagem natural da nossa ilha!",
      sectionActivities: "As Diferentes Atividades",
      sectionActivitiesIntro: "O que varia nos 4 tipos de atividades é o marcador, quanto à forma, intensidade e sistema de disparo, e o tipo de 'bala' ou 'munição'.",
      paintballTitle: "Paintball",
      paintballDesc: "Teve origem, em 1981, nos Estados Unidos quando um grupo de doze pessoas resolveu brincar de 'capturar a bandeira', utilizando as armas de balas de tinta utilizadas para marcar árvores e trilhos. Os jogadores utilizam marcadores (as armas) que disparam bolas de tinta, feitas de uma gelatina fina, recheadas de tinta e amigas do ambiente, que, no impacto, rebentam e deixam uma mancha de tinta. O grande objetivo de cada jogador é nunca ser atingido. Quando um jogador é atingido, e a bola rebenta, fica fora do jogo.",
      paintballBenefits: "Jogar paintball tem diversos benefícios: libertação de stress e aumento progressivo do (bom) humor, desenvolvimento da capacidade de trabalho em equipa, estimula a comunicação e a criação de estratégias, além de que se gasta uma boa quantidade de calorias!",
      lasertagTitle: "LaserTag",
      lasertagDesc: "O Laser Tag, uma evolução tecnológica do tradicional Paintball, é uma atividade em equipa, na qual os participantes não experimentam impacto físico de projéteis nem sujidade, pois todo o jogo é eletrónico. As taggers (nome técnico dos marcadores/armas) emitem feixes de laser que, ao atingirem os sensores fixados nos jogadores (numa fita na cabeça e colete), indicam que foram atingidos.",
      lasertagExtra: "Com diversos modos de jogo e inúmeras configurações possíveis, podemos adaptar as partidas de acordo com as preferências dos clientes, tornando os eventos mais atrativos. Pelo facto de ser tudo eletrónico, elimina a possibilidade de batotas nos jogos e as pontuações são registadas de forma precisa num tablet próprio.",
      gelblasterTitle: "Gel Blaster",
      gelblasterDesc: "Esta atividade em equipa oferece uma experiência semelhante ao Paintball, mas com características distintas ao nível do equipamento e da 'munição'. Os participantes utilizam gel blasters, dispositivos que disparam pequenas esferas biodegradáveis de gel. Esta tecnologia proporciona uma experiência mais leve e com menor impacto físico, sendo particularmente adequada para crianças ou para quem prefere uma abordagem menos intensa e agressiva.",
      gelblasterExtra: "Embora apresente menor precisão e visibilidade no momento do impacto em comparação com o paintball tradicional, o gel blaster destaca-se como uma alternativa inclusiva e segura. É especialmente recomendada para participantes que procuram evitar tanta adrenalina, o risco de algumas marcas físicas (como nódoas negras nas pernas) ou para quem seja mais sensível à intensidade do jogo convencional do Paintball.",
      nerfsTitle: "NERFs",
      nerfsDesc: "Enquanto variante do paintball adaptada ao público infantil, a atividade de NERF Battle proporciona jogos em equipa dinâmicos e seguros, recorrendo a blasters que disparam dardos de espuma. É especialmente indicada para crianças mais novas, oferecendo uma alternativa lúdica e de baixo impacto físico.",
      nerfsExtra: "Esta atividade permite alargar o público-alvo, ao captar a atenção dos mais pequenos e das famílias que procuram experiências mais suaves. Os adultos também podem participar, tornando esta opção ideal para eventos familiares, festas de aniversário ou atividades escolares. Pela sua leveza e segurança, os jogos com NERF são frequentemente integrados em insufláveis temáticos.",
      sectionField: "O Campo de Jogos da Azores4fun no Faial",
      fieldP1: "A Azores4Fun, desde que abriu a atividade de Paintball, em julho de 2021, apostou fortemente na criação de um campo de raiz que oferecesse condições de segurança e desafios físicos que proporcionassem uma verdadeira experiência de batalha aos seus utilizadores.",
      fieldP2: "Desde a sua abertura que o mesmo já foi alvo de inúmeras melhorias, desde a abertura de novas trincheiras, criação de mais postos e obstáculos e recentemente uma zona para os briefings e para o público poder assistir.",
      fieldP3: "O campo da Azores4Fun é muito versátil e bem equipado com trincheiras e variados obstáculos, que pode ser dividido em 6 outros campos, para diferentes grupos numéricos e/ou dificuldades.",
      fieldP4: "Em 2025 a Azores4fun passou a dispor de mais zonas de apoio a eventos, assim como de um insuflável para crianças, onde podem os mais novos jogar NERFs, de uma tenda gigante, onde podem ser montados obstáculos insufláveis para se jogar mesmo com chuva, e duas tendas de apoio mais pequenas. Todo este material pode também ser alugado e usado em eventos fora das instalações da Azores4fun.",
      fieldGoal: "O nosso objetivo passa por organizar eventos com elevado nível de qualidade, conforto e segurança.",
      sectionGames: "Os Diversos Jogos",
      gameTeam: "Equipa vs Equipa",
      gameTeamDesc: "O objetivo é eliminar toda a equipa adversária.",
      gameFreeForAll: "Todos contra Todos",
      gameFreeForAllDesc: "Todos os jogadores jogam uns contra os outros saindo apenas 1 vencedor.",
      gameFreePlay: "Jogo Livre",
      gameFreePlayDesc: "Neste modo de jogo sempre que alguém é atingido tem de retornar à base, podendo voltar ao jogo imediatamente até as suas balas acabarem.",
      gameHostage: "Refém",
      gameHostageDesc: "No modo refém uma das equipas fica numa das bases com o objetivo de proteger um 'refém' enquanto a outra faz de tudo para o recuperar vivo para a sua base.",
      gameConfirmedKill: "Morte Confirmada",
      gameConfirmedKillDesc: "Este tipo de jogo dá para jogar tanto no modo 'equipa vs equipa' como no 'todos contra todos'. Basicamente além da pontuação base de 1 ponto por cada eliminação, cada vez que se conseguir ir até à localização da pessoa atingida, essa eliminação passa a valer 2 pontos.",
      gameFlag: "Jogo da Bandeira",
      gameFlagDesc: "1. A primeira equipa a içar a bandeira da base oposta ganha este jogo. 2. A bandeira começa no centro do campo em pé e durante o jogo uma das equipas tem de a proteger enquanto a outra terá de a tentar colocar no chão. As pessoas atingidas têm de sair de jogo por 30 segundos.",
      gameDefense: "Defesa da Base",
      gameDefenseDesc: "Neste jogo uma das equipas fica na base a defendê-la enquanto a outra tenta avançar para dentro da mesma.",
      gameDomination: "Dominação",
      gameDominationDesc: "Neste modo irá existir 3 ou 5 'bases' e o jogo terá uma duração exata, quando o tempo acabar, ganha a equipa que tiver mais bases conquistadas.",
      sectionPricing: "Preços",
      perPerson: "por pessoa",
      lasertagPricing: "LaserTag",
      lasertagPrices: [
        "2 Horas - 15€",
        "3 Horas - 22€",
        "4 Horas - 28€",
        "Pessoa por Hora extra - 5€"
      ],
      paintballPricing: "Paintball",
      paintballPrices: [
        "Pack Completo Adulto | 100 bolas - 10€",
        "Pack Completo Adulto | 250 bolas - 15€",
        "Pack Completo Adulto | 500 bolas - 20€",
        "Pack Completo Criança | 100 bolas - 10€",
        "100 bolas extra - 7,5€",
        "1000 bolas extra - 40€",
        "2000 bolas - 60€"
      ],
      gelblasterPricing: "Gel Blaster",
      gelblasterPrices: [
        "8 Blasters, 8.000 bolas - 80€/Grupo",
        "10 Blasters, 10.000 bolas - 100€/Grupo",
        "12 Blasters, 12.000 bolas - 120€/Grupo",
        "16 Blasters, 16.000 bolas - 160€/Grupo",
        "10.000 Bolas extra - 60€"
      ],
      nerfsPricing: "NERFs",
      nerfsPrices: [
        "8 NERFs - 60€/hora",
      ...
      discount15: "15% desconto em atividades superiores a 3 horas",
      minimumNote: "As atividades de LaserTag e Paintball só se realizam com um mínimo de 6 pessoas (ou valor equivalente); Máximo de jogadores em campo varia com a atividade. Consulte-nos para mais detalhes.",
      packsInclude: "Os Packs incluem:",
      packItems: [
        "Seguro contra todos os riscos",
        "IVA",
        "Arma/marcador e acessórios"
      ],
      paintballExtras: "+ no Paintball:",
      paintballExtraItems: [
        "Equipamento completo de proteção de cada jogador (1 máscara, 1 colete, 1 proteção de pescoço e 1 par de luvas)",
        "Enchimento das botijas ilimitado"
      ],
      paintballDiscounts: "Descontos Paintball:",
      discount20: "20% para quem tem arma/marcador de Paintball",
      discount30: "30% para quem tem o arma/marcador e equipamento completo",
      offSiteNote: "Atividades fora das instalações da Azores4fun têm um acréscimo de 20€ no total da atividade, para suportar os custos de deslocação",
      rentalInflatable: "Aluguer de insuflável gigante com escorrega e obstáculos",
      inflatable3h: "120€/3 horas sem supervisão",
      inflatable3hSupervised: "150€/3 horas com supervisão",
      rentalTents: "Aluguer de tendas para eventos",
      tent3x6: "3 m x 6 m - 100€/dia",
      tent4x8: "4 m x 8 m - 200€/dia (com montagem)",
      tent16x8: "16 m x 8 m - sob consulta",
      bookNow: "Reservar Agora",
      watchVideo: "Ver Vídeo",
      youtubeVideos: {
        main: "https://www.youtube.com/watch?v=e3InIy17Isw",
    ...
    tourPage: {
      ...
      accessibility: "Viatura acessível a cadeira de rodas",
    ...
    trailsPage: {
      ...
      officialTrailsTitle: "Trilhos Oficiais na Ilha do Faial",
      officialTrailsSubtitle: "11 percursos pedestres oficiais certificados pelo Governo dos Açores",
      officialTrails: [
        { code: "PRC04FAI", name: "Caldeira", type: "Circular", difficulty: "Fácil", distance: "6,80 Km", duration: "2h 30min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/caldeira" },
        { code: "PR06FAI", name: "Dez Vulcões", type: "Linear", difficulty: "Difícil", distance: "19,30 Km", duration: "5h 00min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/dez-vulcoes" },
        { code: "PR03FAI", name: "Levada", type: "Linear", difficulty: "Fácil", distance: "7,60 Km", duration: "2h 30min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/levada" },
        { code: "PRC02FAI", name: "Rocha da Fajã", type: "Circular", difficulty: "Médio", distance: "5,00 Km", duration: "2h 30min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/rocha-da-faja" },
        { code: "PRC09FAI", name: "Ribeirinha", type: "Circular", difficulty: "Fácil", distance: "8,30 Km", duration: "2h 30min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/ribeirinha" },
        { code: "GR01FAI", name: "Faial Costa a Costa", type: "Linear", difficulty: "Difícil", distance: "36,80 Km", duration: "12h 00min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/faial-costa-costa" },
        { code: "PRC05FAI", name: "Morro de Castelo Branco", type: "Circular", difficulty: "Fácil", distance: "3,70 Km", duration: "1h 30min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/morro-de-castelo-branco" },
        { code: "PRC01FAI", name: "Cabeço do Canto", type: "Circular", difficulty: "Médio", distance: "2,50 Km", duration: "2h 00min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/cabeco-do-canto" },
        { code: "PRC08FAI", name: "Entre Montes", type: "Circular", difficulty: "Fácil", distance: "3,40 Km", duration: "1h 30min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/entre-montes" },
        { code: "PR10FAI", name: "Baleeiros", type: "Linear", difficulty: "Difícil", distance: "26,00 Km", duration: "7h 00min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/baleeiros" },
        { code: "PR07FAI", name: "Caminhos Velhos", type: "Linear", difficulty: "Difícil", distance: "17,50 Km", duration: "7h 00min", url: "https://trails.visitazores.com/pt-pt/trilhos-dos-acores/faial/caminhos-velhos" }
      ],
      trailType: "Tipo",
      trailDifficulty: "Dificuldade",
      trailDistance: "Distância",
      trailDuration: "Duração",
      viewTrailDetails: "Ver detalhes",
      bookNow: "Reservar",
      howToBook: "Como Reservar",
      bookSteps: [
    ...
    events: {
      title: "Eventos",
      subtitle: "Eventos memoráveis e celebrações únicas. Tendas, insufláveis, teambuilding e muito mais para tornar o seu evento especial.",
      heroTitle: "O Seu Evento Perfeito",
      heroP1: "Seja uma festa de aniversário inesquecível, um evento corporativo de teambuilding, ou uma celebração especial, a Azores4fun tem tudo o que precisa para criar momentos memoráveis.",
      heroP2: "Com tendas espaçosas, insufláveis divertidos e atividades personalizadas, garantimos que o seu evento seja um sucesso absoluto.",
      heroP3extraBefore: "Para além das nossas emblemáticas atividades de estratégia, como o ",
      heroP3extraAfter: ", temos outras atividades criadas à medida para cada tipo de grupo.",
      ...
      cards: {
        ...
        tentsDesc: "Até 100 pessoas sentadas, perfeitas para qualquer clima",
        entertainment: "Entretenimento",
        entertainmentDesc: "Insufláveis, jogos e atividades para todas as idades",
        corporate: "Eventos Corporativos",
        corporateDesc: "Teambuilding profissional e dinâmicas de grupo"
      },
      altEventTents: "Evento com tendas",
      altTeambuilding: "Teambuilding",
      faqs: [
        {
          question: "Que tipos de eventos organizam?",
      ...
      faqTitle: "Perguntas Frequentes - Eventos",
    },
    ...
    tattoo: {
      ...
      piercingProcessTitle: "Como Funciona",
      piercingProcessSubtitle: "Procedimento seguro e profissional do início ao fim",
      importantInfo: "Importante: Todos os nossos procedimentos seguem rigorosos padrões de higiene e segurança. Utilizamos apenas materiais descartáveis e equipamento esterilizado.",
      bookingForm: {
        title: "Marque a Sua Sessão",
        description: "Preencha o formulário para agendar uma consulta ou sessão",
        name: "Nome",
        email: "Email",
        phone: "Telefone",
        service: "Serviço",
        ...
        serviceOptions: {
          tattooConsult: "Consulta de Tatuagem",
          tattooSession: "Sessão de Tatuagem",
          piercing: "Piercing",
          touchup: "Retoque"
        },
        descriptionLabel: "Descrição",
        descriptionPlaceholder: "Descreva a sua ideia ou necessidade...",
        submit: "Enviar Pedido",
        submitting: "A enviar...",
        successTitle: "Sucesso!",
        successDesc: "A sua solicitação foi enviada. Entraremos em contacto em breve.",
        errorTitle: "Erro",
      ...
      piercings: {
        ...
        microdermal: { title: "Microdermal", healing: "Cicatrização: 3-6 meses", desc: "Implantes dérmicos para áreas únicas do corpo." }
      },
      portfolio: {
      ...
      tattooProcess: [
        ...
        "Criação de design personalizado adaptado ao seu estilo",
        "Preparação profissional da pele e área de trabalho",
        "Execução da tatuagem com técnicas modernas",
        "Instruções detalhadas de cuidados pós-sessão"
      ],
      piercingProcess: [
        "Avaliação da anatomia e escolha do local ideal",
        "Seleção de joia hipoalergénica de qualidade",
        "Marcação precisa e esterilização completa",
        "Execução rápida e profissional do piercing",
        "Orientações completas para cicatrização"
      ],
      tattooHighlights: [
      ...
      aftercare: {
        ...
        subtitle: "Instruções essenciais para uma cicatrização perfeita",
        first24h: {
          title: "Primeiras 24 Horas",
          desc: "Mantenha a película protectora. Lave suavemente com sabão neutro após 3-4 horas."
        },
        moisturize: {
          title: "Hidratação",
          desc: "Aplique pomada recomendada 2-3 vezes ao dia. Não use produtos com perfume."
        },
        sunProtection: {
          title: "Protecção Solar",
          desc: "Evite exposição solar directa por 3-4 semanas. Use protector FPS 50+."
        },
        healing: {
          title: "Cicatrização",
          desc: "Não coce nem arranque cascas. Evite piscinas e mar por 3-4 semanas."
        }
      },
      altTattooWork1: "Trabalho de tatuagem 1",
      altTattooWork2: "Trabalho de tatuagem 2",
      altTattooWork3: "Trabalho de tatuagem 3",
      altTattooWork4: "Trabalho de tatuagem 4",
      ...
      faqs: [
        {
          question: "Quanto tempo demora uma sessão de tatuagem?",
          answer: "Depende do tamanho e complexidade. Tatuagens pequenas podem levar 1-2 horas, enquanto peças maiores podem necessitar de múltiplas sessões."
        },
        {
          question: "A tatuagem dói muito?",
          answer: "A sensibilidade varia de pessoa para pessoa e da área do corpo. Muitos descrevem como um desconforto tolerável. Fazemos pausas sempre que necessário."
        },
        {
          question: "Posso trazer o meu próprio design?",
          answer: "Sim! Trabalhamos com o seu design ou criamos algo exclusivo para si. Na consulta inicial discutimos todas as opções."
        },
        {
          question: "Quanto tempo leva para cicatrizar um piercing?",
          answer: "Varia conforme o tipo: lóbulo 6-8 semanas, cartilagem 3-9 meses, oral 4-6 semanas. Seguir os cuidados é essencial."
        },
        {
          question: "Que tipo de joia usam nos piercings?",
          answer: "Usamos apenas materiais hipoalergénicos de alta qualidade: titânio ASTM F136, ouro 14k ou aço cirúrgico implant-grade."
        }
      ],
      faqTitle: "Perguntas Frequentes - Tatuagem & Piercings",
    },
    ...
    property: {
      ...
      heroP1: "A Azores4fun oferece serviços completos de gestão imobiliária, desde arrendamento de longa duração, gestão de alojamento local, até à manutenção e renovação de propriedades.",
      heroP2: "Com uma pequena equipa especializada, conhecimento do mercado local e compromisso com a qualidade, garantimos um serviço como se fosse propriedade nossa.",
    ...
    about: {
      ...
      subtitle: "Uma empresa de confiança, comprometida com a sustentabilidade, para o turismo, alojamento e serviços na Horta, Faial, Açores.",
      ...
      storyP1: "A Azores4fun nasceu em 2011, na cidade da Horta, Ilha do Faial. Durante os primeiros oito anos centramos a nossa ação nas atividades náuticas a bordo de um veleiro, desde saídas curtas, pernoitas, cruzeiros inter-ilhas a alugueres longos com e sem skipper.",
      storyP2: "Em 2019 decidimos diversificar para o alojamento local e atividades de natureza, abrindo o nosso 1º Alojamento Local, um T2, a 'Casa da Travessa', e iniciando a recuperação de um clássico Toyota BJ40, destinado a transfers e passeios todo-o-terreno. Com a pandemia em 2020, suspendemos a atividade e aproveitámos para delinear um novo rumo. Em 2021 apostámos no Paintball, construindo um campo de jogos próprio e adquirindo diverso material de jogo.",
      storyP3: "Em 2022 abrimos o 2º apartamento em Alojamento Local, um T3, no mesmo edifício do anterior, e passaram a denominar-se 'Apartamentos Casa da Travessa'. Começamos também a disponibilizar o aluguer de SUPs, Kayaks e material de snorkeling. Em 2023 adquirimos uma carrinha elétrica de 9 lugares para apoio às atividades, tours e transfers de clientes, e obtivemos nova licença de Operador Marítimo-turístico para iniciar os tours de SUP e Kayak.",
      storyP4: "Iniciámos 2024 com a abertura de mais um Alojamento Local, o estúdio 'Azores4fun', num edifício contíguo ao anterior, onde também abrimos a nossa Loja Azores4fun - um espaço para receção de clientes, venda de atividades turísticas e de produtos regionais - e um Estúdio de Tatuagem, onde oferecemos um serviço personalizado de arte e memórias permanentes.",
      storyP5: "O futuro trará muitas novidades! O nosso propósito é simples: inovar e diferenciar o turismo nos Açores, proporcionando experiências únicas e memoráveis a todos os que nos visitam ou que cá vivem. Seja no mar, na terra ou em família, garantimos aventura, segurança e hospitalidade. Venha descobrir connosco o que torna o Faial e os Açores tão especiais!",
      timeline: "A Nossa Evolução",
      milestones: [
        {
          year: "2011-2018",
          title: "O Início Sob as Velas",
          desc: "Nascemos na Horta e centramos a ação nas atividades náuticas a bordo de um veleiro: saídas curtas, pernoitas, cruzeiros inter-ilhas e alugueres com e sem skipper."
        },
        {
          year: "2019-2021",
          title: "Transformação e Resiliência",
          desc: "Diversificámos para alojamento local com a 'Casa da Travessa', iniciámos a recuperação do Toyota BJ40 e, após a pandemia, apostámos no Paintball com campo próprio."
        },
        {
          year: "2022-2023",
          title: "Expansão da Oferta",
          desc: "Abrimos o 2º apartamento, disponibilizámos SUPs, Kayaks e snorkeling, adquirimos carrinha elétrica de 9 lugares e obtivemos licença de Operador Marítimo-turístico."
        },
        {
          year: "2024",
          title: "Inovação e Aventura",
          desc: "Abrimos o estúdio 'Azores4fun', a Loja Azores4fun para receção e produtos regionais, e o Estúdio de Tatuagem para arte e memórias permanentes."
        },
        {
          year: "2025+",
          title: "O Futuro",
      ...
      mission: "Missão",
      missionText: "Proporcionar experiências memoráveis nos Açores, unindo o conforto de um alojamento de qualidade a aventuras emocionantes, sempre guiados por práticas sustentáveis certificadas que protegem a nossa natureza e valorizam a identidade local.",
      vision: "Visão",
      ...
      advantages: [
        "Empresa com 6 serviços integrados ou complementares",
        "Equipamento próprio e moderno",
        "Equipa local experiente e apaixonada",
        "Alojamentos e Loja no centro da Horta",
    ...
    shop: {
      ...
      visitUs: "Visite-nos",
      visitTitle: "Visite a Nossa Loja",
      address: "Rua José Azevedo, Horta, Faial, Açores",
      ...
      cards: {
        ...
        locationDesc: "No coração da Horta, fácil acesso a tudo",
        hours: "Horário Alargado",
        hoursDesc: "Aberto todos os dias da semana",
        staff: "Equipa Dedicada",
  ...
  en: {
    ...
    featured: {
      ...
      lasertag: {
        ...
        highlights: [
          ...
          "Ideal for groups and birthday parties",
          "Gelblaster and Nerfs also available"
        ]
      },
      watersports: {
        title: "Water Sports",
      ...
      tours: {
        ...
        description: "Discover Faial island in a unique and comfortable way in our 9-seater electric van. Customized tours adapted to your interests and pace.",
        highlights: [
    ...
    cta: {
      ...
      subtitle: "Contact us and start planning your perfect Azores experience",
      bookNow: "Book Now",
      contact: "Contact",
    },
    ...
    footer: {
      ...
      legal: {
        termsSite: "Terms and Conditions - Site",
        termsVending: "Terms and Conditions - Vending",
    ...
    contactDialog: {
      ...
      successMessage: "Thank you for contacting us. We'll respond shortly.",
      error: "Error sending",
    ...
    common: {
      ...
      faqNotFound: "Didn't find the answer you were looking for?",
          ...
          faqs: [
            {
              ...
              answer: "Lasertag, Paintball, Gelblaster, Nerfs, SUP and Kayak rentals, customized tours and much more."
            },
            {
              question: "Is prior booking necessary?",
              answer: "Yes, we recommend prior booking to guarantee availability, especially for groups."
            }
          ]
        },
        {
          ...
          faqs: [
            {
              ...
              answer: "Birthday parties, teambuilding, strategy games, corporate events and personalized celebrations."
            },
            {
              question: "Do you provide tents for events?",
              answer: "Yes, we have three tents available, including a large-sized one, perfect for outdoor events."
            }
          ]
        },
        {
          ...
          faqs: [
            {
              ...
              answer: "The studio is located inside the Azores4fun shop, in the center of Horta."
            },
            {
              question: "Is it necessary to make an appointment?",
              answer: "Yes, we work exclusively by appointment to ensure personalized attention."
            }
          ]
        },
        {
          ...
          faqs: [
            {
              ...
              answer: "Long-term rental, property management, maintenance, construction and renovations."
            },
            {
              question: "Do you manage tourist accommodation?",
              answer: "Yes, we manage tourist properties including maintenance, cleaning and booking management."
            }
          ]
        },
        {
          ...
          faqs: [
            {
              ...
              answer: "The shop is in the center of Horta, Faial, being the central point for all our services."
            },
            {
              question: "What products do you sell?",
              answer: "Regional products, Azores4fun merchandising, outdoor equipment and local tourism items."
            }
          ]
        }
      ]
    ...
    accommodation: {
      ...
      bookingsAndAvailability: "Bookings and Availability",
      book: "Book",
      ...
      aptFeatures: {
        ...
        t2Pico: ["2 bedrooms on 1st floor", "1 bedroom in the attic, super cozy", "1 bathroom", "1 spacious living room", "Dishwasher and washing machines"]
      },
      highlights: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "Check-in is from 3:00 PM and check-out is until 11:00 AM. Flexible times can be arranged subject to availability."
        },
        {
        ...
        },
        {
          ...
          answer: "There is free public parking near the apartments. We can provide detailed information about the best options when you make your reservation."
        },
        {
          question: "Do you offer cleaning service during the stay?",
          answer: "For long stays, we offer weekly cleaning service. For shorter stays, cleaning is included at the end of the stay."
        },
        {
    ...
    activities: {
      ...
      whyChoose: "Why Choose Our Activities",
      ...
      highlights: [
        ...
        "Eco-friendly electric van",
        "Premium quality equipment",
        "Flexible schedules",
        "Group packages"
      ],
      altLasertag: "Lasertag in action",
    ...
    // Paintball Page
    paintball: {
      title: "LaserTag, Paintball, GelBlaster & NERFs",
      subtitle: "Guaranteed fun in outdoor strategy games",
      moreInfo: "More Information",
      heroIntro: "If you want to spend a different day and burn some calories, gather your friends and come play one of our strategy games with us.",
      heroP1: "Fun will be constant and you'll 'only' need to have accurate aim and strategic, insightful thinking!",
      heroP2: "Although you have to plan and execute an attack against the 'enemy', with lots of action mixed in, these action and strategy activities are very fun, relaxing and pose no risk to those who practice.",
      heroP3: "We have several types of activities, where what changes is the marker, for all types of players and ages, such as LaserTag, Paintball, Gelblaster and NERFs.",
      heroP4: "There are several types of challenging and very fun games, which can be used with any type of marker, such as Team x Team, Flag Game, Tower Defense or Hostage, so the only condition is to bring good spirits and your team, because the more 'enemies' there are, the more spectacular it will be to play!",
      heroP5: "Finally, it's important to mention that our Paintball and Gelblaster balls are biodegradable, so after a normal 'rain shower' the paint disappears completely, plus we are confined to an exclusive field for this activity, so we won't leave traces on the natural landscape of our island!",
      sectionActivities: "The Different Activities",
      sectionActivitiesIntro: "What varies in the 4 types of activities is the marker, in terms of form, intensity and firing system, and the type of 'bullet' or 'ammunition'.",
      paintballTitle: "Paintball",
      paintballDesc: "It originated in 1981 in the United States when a group of twelve people decided to play 'capture the flag', using paint ball guns used to mark trees and trails. Players use markers (the guns) that fire paint balls, made of a thin gelatin, filled with environmentally friendly paint, which, on impact, burst and leave a paint stain. The main goal of each player is to never be hit. When a player is hit, and the ball bursts, they are out of the game.",
      paintballBenefits: "Playing paintball has several benefits: stress relief and progressive increase in (good) humor, development of teamwork capacity, stimulates communication and strategy creation, plus you burn a good amount of calories!",
      lasertagTitle: "LaserTag",
      lasertagDesc: "Laser Tag, a technological evolution of traditional Paintball, is a team activity in which participants don't experience physical impact of projectiles or dirt, as the whole game is electronic. The taggers (technical name for markers/guns) emit laser beams that, when hitting the sensors attached to the players (on a headband and vest), indicate they have been hit.",
      lasertagExtra: "With various game modes and numerous possible configurations, we can adapt the matches according to client preferences, making events more attractive. Because everything is electronic, it eliminates the possibility of cheating in games and scores are accurately recorded on a dedicated tablet.",
      gelblasterTitle: "Gel Blaster",
      gelblasterDesc: "This team activity offers an experience similar to Paintball, but with distinct characteristics in terms of equipment and 'ammunition'. Participants use gel blasters, devices that fire small biodegradable gel spheres. This technology provides a lighter experience with less physical impact, being particularly suitable for children or those who prefer a less intense and aggressive approach.",
      gelblasterExtra: "Although it presents less precision and visibility at the moment of impact compared to traditional paintball, the gel blaster stands out as an inclusive and safe alternative. It is especially recommended for participants who seek to avoid so much adrenaline, the risk of some physical marks (like bruises on legs) or for those who are more sensitive to the intensity of conventional Paintball.",
      nerfsTitle: "NERFs",
      nerfsDesc: "As a paintball variant adapted for children, the NERF Battle activity provides dynamic and safe team games, using blasters that fire foam darts. It is especially suitable for younger children, offering a playful and low physical impact alternative.",
      nerfsExtra: "This activity allows expanding the target audience, by capturing the attention of the little ones and families looking for softer experiences. Adults can also participate, making this option ideal for family events, birthday parties or school activities. Due to its lightness and safety, NERF games are often integrated into themed inflatables.",
      sectionField: "The Azores4fun Game Field in Faial",
      fieldP1: "Azores4Fun, since opening the Paintball activity in July 2021, has invested heavily in creating a field from scratch that offers safety conditions and physical challenges that provide a true battle experience for its users.",
      fieldP2: "Since its opening, it has already undergone numerous improvements, from the opening of new trenches, creation of more posts and obstacles and recently an area for briefings and for the public to watch.",
      fieldP3: "The Azores4Fun field is very versatile and well equipped with trenches and various obstacles, which can be divided into 6 other fields, for different group sizes and/or difficulties.",
      fieldP4: "In 2025 Azores4fun started to have more event support areas, as well as an inflatable for children, where the little ones can play NERFs, a giant tent, where inflatable obstacles can be set up to play even in the rain, and two smaller support tents. All this material can also be rented and used at events outside Azores4fun's facilities.",
      fieldGoal: "Our goal is to organize events with a high level of quality, comfort and safety.",
      sectionGames: "The Various Games",
      gameTeam: "Team vs Team",
      gameTeamDesc: "The objective is to eliminate the entire opposing team.",
      gameFreeForAll: "Free for All",
      gameFreeForAllDesc: "All players play against each other with only 1 winner.",
      gameFreePlay: "Free Play",
      gameFreePlayDesc: "In this game mode whenever someone is hit they have to return to base, being able to return to the game immediately until their balls run out.",
      gameHostage: "Hostage",
      gameHostageDesc: "In hostage mode one of the teams stays at one of the bases with the objective of protecting a 'hostage' while the other does everything to recover them alive to their base.",
      gameConfirmedKill: "Confirmed Kill",
      gameConfirmedKillDesc: "This type of game can be played in both 'team vs team' and 'free for all' mode. Basically besides the base score of 1 point for each elimination, every time you manage to go to the location of the person hit, that elimination becomes worth 2 points.",
      gameFlag: "Flag Game",
      gameFlagDesc: "1. The first team to raise the flag of the opposite base wins this game. 2. The flag starts in the center of the field standing and during the game one of the teams has to protect it while the other has to try to put it on the ground. People hit have to leave the game for 30 seconds.",
      gameDefense: "Base Defense",
      gameDefenseDesc: "In this game one of the teams stays at the base to defend it while the other tries to advance into it.",
      gameDomination: "Domination",
      gameDominationDesc: "In this mode there will be 3 or 5 'bases' and the game will have an exact duration, when time runs out, the team with the most bases conquered wins.",
      ...
      lasertagPrices: [
        ...
        "3 Hours - €22",
        "4 Hours - €28",
        "Person per Extra Hour - €5"
      ],
      paintballPricing: "Paintball",
      paintballPrices: [
        "Complete Adult Pack | 100 balls - €10",
        "Complete Adult Pack | 250 balls - €15",
        "Complete Adult Pack | 500 balls - €20",
        "Complete Child Pack | 100 balls - €10",
        "100 extra balls - €7.50",
        "1000 extra balls - €40",
        "2000 balls - €60"
      ],
      gelblasterPricing: "Gel Blaster",
      gelblasterPrices: [
        "8 Blasters, 8,000 balls - €80/Group",
        "10 Blasters, 10,000 balls - €100/Group",
        "12 Blasters, 12,000 balls - €120/Group",
        "16 Blasters, 16,000 balls - €160/Group",
        "10,000 Extra balls - €60"
      ],
      nerfsPricing: "NERFs",
      nerfsPrices: [
        "8 NERFs - €60/hour",
      ...
      discount15: "15% discount on activities over 3 hours",
      minimumNote: "LaserTag and Paintball activities only take place with a minimum of 6 people (or equivalent value); Maximum players on the field varies with the activity. Contact us for more details.",
      packsInclude: "Packs include:",
      packItems: [
        "Insurance against all risks",
        "VAT",
        "Marker/gun and accessories"
      ],
      paintballExtras: "+ in Paintball:",
      paintballExtraItems: [
        "Complete protection equipment for each player (1 mask, 1 vest, 1 neck protection and 1 pair of gloves)",
        "Unlimited tank refilling"
      ],
      paintballDiscounts: "Paintball Discounts:",
      discount20: "20% for those who have their own Paintball marker/gun",
      discount30: "30% for those who have the marker/gun and complete equipment",
      offSiteNote: "Activities outside Azores4fun facilities have an additional €20 charge on the total activity cost, to cover travel expenses",
      rentalInflatable: "Giant inflatable rental with slide and obstacles",
      inflatable3h: "€120/3 hours without supervision",
      inflatable3hSupervised: "€150/3 hours with supervision",
      rentalTents: "Tent rental for events",
      tent3x6: "3 m x 6 m - €100/day",
      tent4x8: "4 m x 8 m - €200/day (with assembly)",
      tent16x8: "16 m x 8 m - on request",
      bookNow: "Book Now",
    ...
    tourPage: {
      ...
      accessibility: "Vehicle wheelchair accessible",
    ...
    trailsPage: {
      ...
      officialTrailsTitle: "Official Trails on Faial Island",
      officialTrailsSubtitle: "11 official hiking trails certified by the Azores Government",
      officialTrails: [
        { code: "PRC04FAI", name: "Caldeira", type: "Circular", difficulty: "Easy", distance: "6.80 Km", duration: "2h 30min", url: "https://trails.visitazores.com/en/trails-azores/faial/caldeira" },
        { code: "PR06FAI", name: "Ten Volcanoes", type: "Linear", difficulty: "Difficult", distance: "19.30 Km", duration: "5h 00min", url: "https://trails.visitazores.com/en/trails-azores/faial/dez-vulcoes" },
        { code: "PR03FAI", name: "Levada", type: "Linear", difficulty: "Easy", distance: "7.60 Km", duration: "2h 30min", url: "https://trails.visitazores.com/en/trails-azores/faial/levada" },
        { code: "PRC02FAI", name: "Rocha da Fajã", type: "Circular", difficulty: "Medium", distance: "5.00 Km", duration: "2h 30min", url: "https://trails.visitazores.com/en/trails-azores/faial/rocha-da-faja" },
        { code: "PRC09FAI", name: "Ribeirinha", type: "Circular", difficulty: "Easy", distance: "8.30 Km", duration: "2h 30min", url: "https://trails.visitazores.com/en/trails-azores/faial/ribeirinha" },
        { code: "GR01FAI", name: "Faial Coast to Coast", type: "Linear", difficulty: "Difficult", distance: "36.80 Km", duration: "12h 00min", url: "https://trails.visitazores.com/en/trails-azores/faial/faial-costa-costa" },
        { code: "PRC05FAI", name: "Morro de Castelo Branco", type: "Circular", difficulty: "Easy", distance: "3.70 Km", duration: "1h 30min", url: "https://trails.visitazores.com/en/trails-azores/faial/morro-de-castelo-branco" },
        { code: "PRC01FAI", name: "Cabeço do Canto", type: "Circular", difficulty: "Medium", distance: "2.50 Km", duration: "2h 00min", url: "https://trails.visitazores.com/en/trails-azores/faial/cabeco-do-canto" },
        { code: "PRC08FAI", name: "Entre Montes", type: "Circular", difficulty: "Easy", distance: "3.40 Km", duration: "1h 30min", url: "https://trails.visitazores.com/en/trails-azores/faial/entre-montes" },
        { code: "PR10FAI", name: "Baleeiros", type: "Linear", difficulty: "Difficult", distance: "26.00 Km", duration: "7h 00min", url: "https://trails.visitazores.com/en/trails-azores/faial/baleeiros" },
        { code: "PR07FAI", name: "Caminhos Velhos", type: "Linear", difficulty: "Difficult", distance: "17.50 Km", duration: "7h 00min", url: "https://trails.visitazores.com/en/trails-azores/faial/caminhos-velhos" }
      ],
      trailType: "Type",
      trailDifficulty: "Difficulty",
      trailDistance: "Distance",
      trailDuration: "Duration",
      viewTrailDetails: "View details",
      bookNow: "Book Now",
      howToBook: "How to Book",
      bookSteps: [
    ...
    events: {
      title: "Events",
      subtitle: "Memorable events and unique celebrations. Tents, inflatables, teambuilding and much more to make your event special.",
      heroTitle: "Your Perfect Event",
      heroP1: "Whether it's an unforgettable birthday party, a corporate teambuilding event, or a special celebration, Azores4fun has everything you need to create memorable moments.",
      heroP2: "With spacious tents, fun inflatables and customized activities, we guarantee your event will be an absolute success.",
      heroP3extraBefore: "Beyond our iconic strategy activities such as ",
      heroP3extraAfter: ", we have other activities tailored to each type of group.",
      ...
      cards: {
        ...
        tentsDesc: "Up to 100 seated people, perfect for any weather",
        entertainment: "Entertainment",
        entertainmentDesc: "Inflatables, games and activities for all ages",
        corporate: "Corporate Events",
        corporateDesc: "Professional teambuilding and group dynamics"
      },
      altEventTents: "Event celebration with tents",
      altTeambuilding: "Teambuilding activity",
      faqs: [
        {
          question: "What types of events do you organize?",
          answer: "We organize birthday parties, teambuilding events, strategy games, corporate parties, family celebrations and any type of personalized event you need."
        },
        {
          question: "Do you provide tents for events?",
          answer: "Yes, we have three tents available, including a large one, perfect for outdoor events. Tents can be rented with or without assembly included."
        },
        {
          question: "Do you have inflatables for birthday parties?",
          answer: "Yes, we have various inflatables available for rent, ideal for children's birthday parties. Includes delivery, setup and teardown."
        },
        {
          question: "Can you travel to other locations?",
          answer: "Yes! Our activities are mobile. We can travel to your chosen location on Faial island with tents, inflatables and necessary equipment."
        },
        {
          question: "Do you offer complete packages for events?",
          answer: "Yes, we create personalized packages that can include space (tents), activities, equipment, catering (through partners) and everything you need for your event."
        },
        {
          question: "What is the maximum capacity of the tents?",
          answer: "Our large tent accommodates up to 100 seated people or 150 standing. The smaller tents accommodate 30-40 people each."
        },
        {
          question: "How far in advance should I book?",
          answer: "For large events, we recommend booking at least 4 weeks in advance. For smaller events, 2 weeks is generally sufficient."
        },
        {
          question: "Do you do decoration for events?",
          answer: "We can help with basic decoration or work with specialized event decoration partners. Tell us your vision and we'll make it reality!"
        }
      ],
      faqTitle: "Frequently Asked Questions - Events",
    },
    ...
    tattoo: {
      ...
      piercingProcessTitle: "How It Works",
      piercingProcessSubtitle: "Safe and professional procedure from start to finish",
      importantInfo: "Important: All our procedures follow strict hygiene and safety standards. We use only disposable materials and sterilized equipment.",
      bookingForm: {
        title: "Book Your Session",
        description: "Fill out the form to schedule a consultation or session",
        name: "Name",
        email: "Email",
        phone: "Phone",
        service: "Service",
        ...
        serviceOptions: {
          tattooConsult: "Tattoo Consultation",
          tattooSession: "Tattoo Session",
          piercing: "Piercing",
          touchup: "Touch-up"
        },
        descriptionLabel: "Description",
        descriptionPlaceholder: "Describe your idea or need...",
        submit: "Submit Request",
        submitting: "Sending...",
        successTitle: "Success!",
        successDesc: "Your request has been sent. We'll be in touch soon.",
        errorTitle: "Error",
      ...
      piercings: {
        ...
        microdermal: { title: "Microdermal", healing: "Healing: 3-6 months", desc: "Dermal implants for unique body areas." }
      },
      portfolio: {
        title: "Our Portfolio",
      ...
      tattooProcess: [
        ...
        "Creation of personalized design adapted to your style",
        "Professional skin and workspace preparation",
        "Tattoo execution with modern techniques",
        "Detailed aftercare instructions"
      ],
      piercingProcess: [
        "Anatomy assessment and ideal location choice",
        "Selection of quality hypoallergenic jewelry",
        "Precise marking and complete sterilization",
        "Quick and professional piercing execution",
        "Complete healing guidelines"
      ],
      tattooHighlights: [
      ...
      aftercare: {
        title: "Aftercare",
        subtitle: "Essential instructions for perfect healing",
        first24h: {
          title: "First 24 Hours",
          desc: "Keep the protective film. Wash gently with neutral soap after 3-4 hours."
        },
        moisturize: {
          title: "Moisturizing",
          desc: "Apply recommended ointment 2-3 times a day. Don't use perfumed products."
        },
        sunProtection: {
          title: "Sun Protection",
          desc: "Avoid direct sun exposure for 3-4 weeks. Use SPF 50+ sunscreen."
        },
        healing: {
          title: "Healing",
          desc: "Don't scratch or pick scabs. Avoid pools and sea for 3-4 weeks."
        }
      },
      altTattooWork1: "Tattoo artwork 1",
      altTattooWork2: "Tattoo artwork 2",
      altTattooWork3: "Tattoo artwork 3",
      altTattooWork4: "Tattoo artwork 4",
      ...
      faqs: [
        {
          ...
          answer: "It depends on the size and complexity. Small tattoos can take 1-2 hours, while larger pieces may require multiple sessions."
        },
        {
          question: "Does tattooing hurt a lot?",
          answer: "Sensitivity varies from person to person and body area. Many describe it as a tolerable discomfort. We take breaks whenever necessary."
        },
        {
          question: "Can I bring my own design?",
          answer: "Yes! We work with your design or create something exclusive for you. We discuss all options in the initial consultation."
        },
        {
          question: "How long does it take for a piercing to heal?",
          answer: "It varies by type: lobe 6-8 weeks, cartilage 3-9 months, oral 4-6 weeks. Following care instructions is essential."
        },
        {
          question: "What type of jewelry do you use for piercings?",
          answer: "We only use high-quality hypoallergenic materials: ASTM F136 titanium, 14k gold or implant-grade surgical steel."
        }
      ],
      faqTitle: "Frequently Asked Questions - Tattoo & Piercings",
    },
    ...
    property: {
      ...
      heroP1: "Azores4fun offers complete property management services, from long-term rentals, local accommodation management, to property maintenance and renovation.",
      heroP2: "With a small specialized team, knowledge of the local market and commitment to quality, we guarantee a service as if it were our own property.",
      contactUs: "Contact Us",
      ...
      highlights: [
        ...
        "Licenses and insurance up to date",
    ...
    about: {
      ...
      subtitle: "A trusted company, committed to sustainability, for tourism, accommodation and services in Horta, Faial, Azores.",
      ...
      storyP1: "Azores4fun was born in 2011, in the city of Horta, Faial Island. During the first eight years, we focused our activities on nautical experiences aboard a sailboat, from short trips, overnight stays, inter-island cruises to long rentals with and without skipper.",
      storyP2: "In 2019, we decided to diversify into local accommodation and nature activities, opening our first Local Accommodation, a 2-bedroom apartment called 'Casa da Travessa', and starting the restoration of a classic Toyota BJ40 for transfers and off-road tours. With the pandemic in 2020, we suspended activities and took the opportunity to chart a new course. In 2021, we invested in Paintball, building our own playing field and acquiring various game equipment.",
      storyP3: "In 2022, we opened the 2nd apartment in Local Accommodation, a 3-bedroom unit in the same building as the previous one, and they became known as 'Apartamentos Casa da Travessa'. We also started offering SUP, Kayak and snorkeling equipment rentals. In 2023, we acquired a 9-seater electric van to support activities, tours and client transfers, and obtained a new Maritime Tourism Operator license to start SUP and Kayak tours.",
      storyP4: "We started 2024 with the opening of another Local Accommodation, the 'Azores4fun' studio, in an adjacent building, where we also opened our Azores4fun Shop - a space for client reception, sale of tourist activities and regional products - and a Tattoo Studio, where we offer a personalized service of art and permanent memories.",
      storyP5: "The future will bring many new developments! Our purpose is simple: to innovate and differentiate tourism in the Azores, providing unique and memorable experiences to all who visit or live here. Whether at sea, on land or with family, we guarantee adventure, safety and hospitality. Come discover with us what makes Faial and the Azores so special!",
      timeline: "Our Evolution",
      milestones: [
        {
          year: "2011-2018",
          title: "The Beginning Under Sail",
          desc: "We were born in Horta and focused on nautical activities aboard a sailboat: short trips, overnight stays, inter-island cruises and rentals with and without skipper."
        },
        {
          year: "2019-2021",
          title: "Transformation and Resilience",
          desc: "We diversified into local accommodation with 'Casa da Travessa', started restoring the Toyota BJ40, and after the pandemic, invested in Paintball with our own field."
        },
        {
          year: "2022-2023",
          title: "Expanding the Offer",
          desc: "We opened the 2nd apartment, offered SUPs, Kayaks and snorkeling, acquired a 9-seater electric van and obtained a Maritime Tourism Operator license."
        },
        {
          year: "2024",
          title: "Innovation and Adventure",
          desc: "We opened the 'Azores4fun' studio, the Azores4fun Shop for reception and regional products, and the Tattoo Studio for art and permanent memories."
        },
        {
          year: "2025+",
          title: "The Future",
      ...
      mission: "Mission",
      missionText: "To provide memorable experiences in the Azores, combining the comfort of quality accommodation with exciting adventures, always guided by certified sustainable practices that protect our nature and value local identity.",
      vision: "Vision",
      ...
      advantages: [
        "Company with 6 integrated or complementary services",
        "Modern equipment and facilities",
        "Experienced and passionate local team",
        "Accommodations and Shop in the center of Horta",
    ...
    shop: {
      ...
      address: "Rua José Azevedo, Horta, Faial, Azores",
      ...
      cards: {
        ...
        locationDesc: "In the heart of Horta, easy access to everything",
        hours: "Extended Hours",
        hoursDesc: "Open every day of the week",
        staff: "Dedicated Team",
