export const translations = {
  pt: {
    ...
    accommodation: {
      ...
      aptFeatures: {
        t1: ["1 Mezzanine", "1 casa de banho", "1 zona de estar ampla", "1 kitchenette bem equipada", "1 lavandaria com máquina de lavar e secar", "Ar condicionado e redes mosquiteiras"],
        t2Centro: ["2 quartos", "1 casa de banho com banheira", "1 sala e cozinha totalmente equipada", "1 máquina lavar roupa", "1 pátio", "Ar condicionado e redes mosquiteiras"],
        t2Pico: ["2 quartos no 1º piso", "1 quarto no sótão, super acolhedor", "1 casa de banho", "1 sala ampla", "1 cozinha equipada com máquina de lavar loiça", "1 máquina de lavar roupa", "Ar condicionado e redes mosquiteiras"]
      },
      highlights: {
        location: "Localização Premium",
        locationDesc: "Centro da Horta, a poucos minutos a pé de restaurantes, lojas e marina",
        wifi: "Wi-Fi Grátis",
  ...
  en: {
    ...
    accommodation: {
      ...
      aptFeatures: {
        t1: ["1 Mezzanine", "1 bathroom", "1 spacious living area", "1 well-equipped kitchenette", "1 laundry room with washer and dryer", "Air conditioning and mosquito nets"],
        t2Centro: ["2 bedrooms", "1 bathroom with bathtub", "1 fully equipped living room and kitchen", "1 washing machine", "1 patio", "Air conditioning and mosquito nets"],
        t2Pico: ["2 bedrooms on 1st floor", "1 bedroom in the attic, super cozy", "1 bathroom", "1 spacious living room", "1 kitchen equipped with dishwasher", "1 washing machine", "Air conditioning and mosquito nets"]
      },
      highlights: {
        location: "Premium Location",
        locationDesc: "Center of Horta, minutes walk from restaurants, shops and marina",
        wifi: "Free Wi-Fi",
