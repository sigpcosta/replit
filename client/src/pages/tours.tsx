...
import { MapPin, Clock, Globe, Users, Check, Leaf, Camera, Mountain, Waves, Sun, Backpack, ExternalLink, Accessibility, CalendarX2, CreditCard } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        keywords="tour faial, eco tour azores, capelinhos volcano, caldeira faial, electric van tour, sustainable tourism azores, guided tour faial island"
        canonicalPath="/tours"
      />
      <Navigation />
